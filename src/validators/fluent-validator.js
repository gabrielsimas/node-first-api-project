...
//TODO: Criar o Maior ou Igual e Menor ou Igual
...
ValidationContract.prototype.isGreaterThen = (value, message) => {
  if (!value || value.length <= value) errors.push({ message: message });
};

ValidationContract.prototype.isLessThen = (value, message) => {
  if (!value || value.length >= value) errors.push({ message: message });
};
